...
claves_rpc_1(char *host)
{
	...
	int result_2;
	struct params set_value_1_arg1;
	enum clnt_stat retval_3;
	struct get_value_res result_3;
	char *get_value_1_key;
	enum clnt_stat retval_4;
	int result_4;
	struct params modify_value_1_arg1;
...
#ifndef	DEBUG
	clnt = clnt_create (host, CLAVES_RPC, CLAVES_VER, "udp");
	if (clnt == NULL) {
